...
* While the file **00.prepdara.R** is an ancillary file to generate lagged variables for dust exposures and PM10 and the smooth terms to adjust for temperature.
