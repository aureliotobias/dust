...
#####                                                                                                                 #####
#####  01.dust_models.R  - Time-series regression models for desert dust exposures.                                   #####
...
str(data)
# date:         date (from 1/1/2005 to 31/12/2010)
# trend:        progressive number from 1 to 2191
# allnat:       daily mortality counts for non-accidental causes 
# temp:         daily mean temperature
# dust:         dust as binare exposure (0= non-dust days, 1= dust days)
# pm10:         daily PM10 concentration
# pm10natural:  daily PM10 concentrations from natural (dust) sources (= 0 when dust=1, >0 when dust= 1)
# pm10local:    daily PM10 concentrations from local or anthropogenic (non-dust) sources (as pm10 - pm10natural)

###########################################################################################################################
### Prepare data for the analysis generating lags for temperature, dust and pm variables.
###########################################################################################################################

source("00.dust_prepdata.R")
...
### Model 1. Binary dust as main exposure
e  <- "Dust (yes/no) - crude"
...
### Model 2 - Binary dust dust as confounder
e  <- "PM10 - crude"
...
### Model 3 - Binary dust dust as effect modifier 
